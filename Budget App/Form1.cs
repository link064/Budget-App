...
namespace Budget_App
{
	public partial class Form1 : Form
	{
		...
		{
            // TODO
			//Comparisons comp = new Comparisons(items, (List<string>)cmbDateSelect.DataSource);
			//comp.Show();
		}
		...
		{
            // TODO
			//List<string> dates = items.Select(i => i.TransDate.ToString("yyyy")).Distinct().ToList();

			//Comparisons comp = new Comparisons(items, dates);
			//comp.Show();
		}
		...
		private void InitGrids()
		{
			...
			dgcolCategory.DataSource = TransactionType.GetNames();
        ...
        void Match_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            {
                trans.TransType = TypeMatching.GetType(trans.Memo, trans.Description);
        ...
        {
            // TODO
            //BalanceGraph graph = new BalanceGraph(items);
            //graph.GeneratePointsLists(GraphPeriod.Annual);
            //graph.Show();
        }
